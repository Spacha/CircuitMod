...
public class AboutFrame extends JDialog implements WindowListener {
	...
	private final String LICENSE = "<HTML>"
	...
	public AboutFrame(CirSim cirSim) {
		...
		JLabel labelNamesTitle = new JLabel(
				"<html>" + "<center>" + "<b>" + NAMES_TITLE + "</b>" + "<br>"
						+ names + "<br>" + "<b>" + NAME_ORIGINAL_TITLE + "</b>"
						+ "<br>" + NAME_ORIGINAL + "</center>" + "</html>");
		...
		JLabel labelLicense = new JLabel("<html>" + "<center>" + "<b>"
				+ LICENSE_TITLE + "</b>" + "<br>" + LICENSE_VERSION
				+ "</center>" + "<br>" + LICENSE + "</html>");
	...
	private void goToWebsite(JLabel website, final String url, String title,
			String text) {
		website.setText("<html><center><b>" + title
				+ "</b></center><a href=\"\">" + text + "</a></html>");
