...
public class ThermistorElm extends CircuitElm {
	...
	void createSlider() {
		int value = 50;
		CirSim.addSidebarComponent(label = new Label("Temperature", Label.CENTER));
	...
	public void getInfo(String arr[]) {
		...
		arr[4] = "Ron = " + getUnitText(minresistance, CirSim.OHM_STR);
		arr[5] = "Roff = " + getUnitText(maxresistance, CirSim.OHM_STR);
	}
