...
public abstract class CircuitElm implements Editable {
	...
	void drawCoil(Graphics g, int hs, Point p1, Point p2, double v1,
			double v2) {
	...
	public static String getUnitText(double v, String u) {
		...
		if (va < 1e-3)
			return showFormat.format(v * 1e6) + " " + CirSim.MU_STR + u;
		if (va < 1)
	...
	static String getShortUnitText(double v, String u) {
		...
		if (va < 1e-3)
			return shortFormat.format(v * 1e6) + CirSim.MU_STR + u;
		if (va < 1)
